...
$__dart_deferred_initializers__.current=function(a,b,c,$){var B={Tf:function Tf(d,e,f,g,h){var _=this
_.cV=d
_.E=e
_.a0=null
_.b3=f
...
_.a=0
_.c=_.b=null},
a78(d,e){return new B.vE(d,e,null)},
...
_.$ti=d},
aEw(d,e,f){var x=null
return new C.r_(new B.zd(e,x,x,x,C.aPo(),B.b5f(),f.i("zd<0>")),x,d,x,x,f.i("r_<0>"))},
aVJ(d,e){if(e!=null)e.l(0)}},A,D,C,E
...
E=c[42]
B.Tf.prototype={
sFd(d,e){if(this.cV.n(0,e))return
this.cV=e
this.ta()},
gpl(){var x=this.cV,w=this.rx
return x.h8(new A.L(0,0,0+w.a,0+w.b))},
ck(d,e){var x=this
if(x.E!=null){x.iF()
if(!x.a0.w(0,e))return!1}return x.it(d,e)},
b1(d,e){var x,w,v=this,u=v.dx
if(v.q$!=null){v.iF()
x=A.b(v.fr,"_needsCompositing")
w=v.a0
u.saN(0,d.an4(x,e,new A.L(w.a,w.b,w.c,w.d),w,A.e4.prototype.gf4.call(v),v.b3,y.a.a(u.a)))}else u.saN(0,null)}}
B.vE.prototype={
aY(d){var x=new B.Tf(this.e,null,D.df,null,A.au(y.d))
x.gaD()
x.gaS()
x.fr=!1
x.sbp(null)
return x},
b2(d,e){e.sFd(0,this.e)
e.siL(D.df)
e.smz(null)}}
B.zd.prototype={
...
try{r=s.a
r.toString
r=v.a(r.$ti.i("e7<1>").a(A.cg.prototype.gG.call(r)).f.e)
u=s.a
u.toString
s.d=r.a.$1(u)}catch(t){x=A.ad(t)
w=A.ao(t)
s.f=new A.bw(x,w,"provider",null,null,!1)
throw t}finally{}r=s.a
r.toString
